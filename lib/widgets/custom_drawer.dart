        ...
        children: [
          DrawerHeader(
            decoration: BoxDecoration(
              color: Colors.white, // Usa el color primario del tema
            ),
            child: const Text(
              'Menú',
              style: TextStyle(
                color: Color.fromARGB(
                  ...
                  0,
                  0,
                ), // Texto blanco para contrastar con el color primario
                fontSize: 24,
              ),
            ),
          ),
          ...
          ListTile(
            ...
            title: const Text('Tips de Seguridad'),
            onTap: () {
              ...
              context.go(
                '/tipsList',
                extra: {'endpoint': '/tips', 'title': 'Tips de Seguridad'},
          ...
          ListTile(
            ...
            onTap: () {
              context.push('/about'); // Navega a la pantalla de acerca de
              Navigator.pop(context); // Cierra el drawer
            },
          ),
        ],
